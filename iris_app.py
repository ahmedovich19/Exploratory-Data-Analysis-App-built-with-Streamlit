"""
## App: Iris EDA App
Author: [Ahmed Hamdy(AhmedHamdy)](https://github.com/ahmedovich19))\n
Source: [Github](https://github.com/ahmedovich19/Exploratory Data Analysis App built with Streamlit
)
